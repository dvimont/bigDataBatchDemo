 ...
 */
public class WikimediaFileDownloaderMonthly {
    ...
    public static String WORKSPACE_PATH_PREFIX_STRING = "./raw_files/";
    ...
    public static void main( String[] args ) throws Exception {
        ...
        if (args.length > 0) {
            if (args[0].toLowerCase().equals("sample")) {
                filePath = WikimediaFileDownloaderMonthly.FIXED_SAMPLE;
            } else {
                filePath = args[0];
                if (args.length > 1) {
                    WORKSPACE_PATH_PREFIX_STRING = args[1];
                    processingLimit = Integer.valueOf(args[2]);
                }
            }
        }
